...
using (SqliteConnection connection = new SqliteConnection(connectionString))
{
    ...
    string createTableQuery = "CREATE TABLE IF NOT EXISTS Productos (idProducto INTEGER PRIMARY KEY, Descripcion TEXT, Precio INTEGER)";
    ...
    // Insertar datos
    string insertQuery = "INSERT INTO Productos (Descripcion, Precio) VALUES ('Manzana', 50), ('Banana', 30)";
